...
import filter.nonlinear_system as nonlinear_system
...
class EnsembleKalmanFilter(nonlinear_system.NonLinearSystem):
    ...
    def __init__(self,
                 ...
                 time_delta = 1.0,
                 cyclical = False):
        super(EnsembleKalmanFilter, self).__init__(model_details, proc_var, time_delta, len(initial_phase_mean) - 1)
    ...
    def localize(self, measurement, measurement_noise, big_psi, return_phase_variance = False):
