...
class NonLinearSystem(object):
    ...
    #
    def __init__(self, model_details, proc_var, time_delta, system_order):
        ...
        self.state_dimension = model_details["state_dimension"]
        self.measurement_dimension = model_details["num_observed_dof"]
        ...
        self.measurement_model_prototype = 0 #np.zeros((self.system_size + self.basis_model.block_prototype.shape[0], self.basis_model.num_observed_dof))
        #self.measurement_model_prototype = np.zeros(
            #(self.system_size + self.basis_model.block_prototype.shape[0], self.basis_model.num_observed_dof))
    ...
    def get_phase_process_noise(self):
        ...
        ], dtype = constants.DTYPE) * self.proc_var
