...
for i in range(len(train_x)):
    ...
    seg_ranges.append(state_segmentation(train_x[i], train_y[i], train_psi[i], train_vx[i], train_vy[i], plot=False, seg_whole= True, plot_states= False))
...
seg_ranges_obv = []
for i in range(len(test_x)):
     seg_test_obs = state_segmentation(test_x[i], test_y[i],  test_psi[i], test_vx[i], test_vy[i], plot=False, seg_whole= True)
